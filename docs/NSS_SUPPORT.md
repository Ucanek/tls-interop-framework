...
| **Compose** | `deploy/combos/matrix.yaml` – jeden stack, páry přes `SERVER_WRAPPER` / `CLIENT_WRAPPER`. CI: `./scripts/run_all_combos.sh` (8 kombinací; **GnuTLS×NSS** přeskočena – viz [KNOWN_LIMITATIONS.md](KNOWN_LIMITATIONS.md)). |
