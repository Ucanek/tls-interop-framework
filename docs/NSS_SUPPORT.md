...
| **Compose** | `deploy/matrix.yaml` + `./scripts/run.sh` (`docker`); workaround GnuTLS×NSS v [matrix_env.py](../src/wrappers/matrix_env.py) / [KNOWN_LIMITATIONS.md](KNOWN_LIMITATIONS.md). |
